...
public class ChessBoard
{
   ...
   */
   public boolean move(int x1, int y1, int x2, int y2)
   {
	   ...
	   int[][] possibleMoves = board[x1][y1].getPossibleMoves(x1, y1);
	   int row = possibleMoves.length;
	   //compaires possibleMove to the array of all possible moves generated by that piece
	   for(int i = 0; i < row ; i ++)
	   {
		   if(possibleMoves[i][0] == x2 && possibleMoves[i][1] == y2)
		   {   
