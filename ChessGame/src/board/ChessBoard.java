...
public class ChessBoard
{
   ...
   public ChessBoard()
   {
      ...
      */ 
      ...
      for(int i = 2; i < 6; i++)
      {
    	  for(int j = 0; j < 8; j ++)
    	  {
    		  this.board[i][j] = new ChessPiece("EmptySpace", 3);
    	  }
      }
   }
   ...
   */
   public boolean move(int x1, int y1, int x2, int y2)
   {
	   ...
	   this.possibleMoves = this.board[x1][y1].getPossibleMoves(x1, y1);
	   this.row = this.possibleMoves.length;
	   //Compares possibleMove to the array of all possible moves generated by that piece
	   for(int i = 0; i < this.row ; i ++)
	   {
		   if(this.possibleMoves[i][0] == x2 && this.possibleMoves[i][1] == y2)
		   {   
